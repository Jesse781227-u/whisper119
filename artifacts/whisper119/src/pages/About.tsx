  ...
  return (
    <main className="min-h-screen py-24 px-4">
      <div className="container mx-auto max-w-2xl">
        <h1 className="text-4xl md:text-5xl font-serif mb-12">About Whisper 119</h1>
        
        <div className="prose prose-neutral dark:prose-invert text-lg leading-relaxed space-y-6">
          <p>
            Whisper 119 is a one-person bookshop. There's no warehouse, no algorithm and no recommendations engine — just a shelf of titles chosen carefully and sold as clean, DRM-free EPUB and PDF files.
          </p>
          <p>
          ...
          <p>
            Thank you for visiting a smaller, quieter corner of the internet.
          </p>
        </div>
      </div>
    </main>
