...
export default function Admin() {
  ...
  const revenueByCurrency = dashboard.data?.revenueByCurrency ?? { USD: dashboard.data?.totalRevenue ?? 0, NGN: 0 }
